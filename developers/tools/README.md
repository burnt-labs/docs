...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Mob: multi-platform signing library</strong></td><td>Sign and send, query chain state, gasless transfers, authz session keys, and meta-account authenticators—same API surface across supported languages.</td><td><a href="mob-a-multi-platform-signing-client-library-for-xion.md">mob-a-multi-platform-signing-client-library-for-xion.md</a></td></tr></tbody></table>
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Xion Agent Toolkit</strong></td><td>Gasless development with Meta Accounts, Treasury management, and OAuth2 client management. <strong>Beta</strong>—testnet (default) and mainnet (<code>--network mainnet</code>); faucet is testnet-only.</td><td><a href="xion-toolkit.md">xion-toolkit.md</a></td></tr><tr><td><strong>Xion Daemon (xiond) CLI</strong></td><td>Traditional chain CLI for querying and transacting directly with XION endpoints.</td><td><a href="xiond-cli.md">xiond-cli.md</a></td></tr></tbody></table>
