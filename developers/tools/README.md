...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Xion Agent Toolkit</strong></td><td>Gasless development with Meta Accounts, Treasury management, and OAuth2 client management. <strong>Beta</strong>—testnet only; mainnet not supported yet.</td><td><a href="xion-toolkit.md">xion-toolkit.md</a></td></tr><tr><td><strong>Xion Daemon (xiond) CLI</strong></td><td>Traditional chain CLI for querying and transacting directly with XION endpoints.</td><td><a href="xiond-cli.md">xiond-cli.md</a></td></tr></tbody></table>
