# $VERONA Token Contract Addresses on EVM Chains (Previously $XION)

Below are the official contract addresses for the $VERONA token (Previously $XION) across supported EVM-compatible networks. Always verify addresses through official explorer links before interacting with the token.

| Chain     | Chain ID | $VERONA Token Address                        | Explorer Link                                                                                                      |
| --------- | -------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
