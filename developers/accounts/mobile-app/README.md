...
[**Build a React Native Mobile app in 5 Minutes**](../../computation/quick-start/zero-to-dapp-in-5-minutes/react-native-mobile-dapp-in-5-minutes.md)
...
The [`@burnt-labs/abstraxion-react-native`](https://www.npmjs.com/package/@burnt-labs/abstraxion-react-native) package is the core library for building mobile apps on Verona. It brings the full power of the Abstraxion Meta Account system and simplifies authentication, signing, and fee grants in a native mobile environment.
