...
You'll need $VERONA test tokens (Previously $XION) to interact with the network. These are free and available through [Requesting Testnet Tokens](../references/testnet-tokens.md). Once funded, connect using [Public Endpoints & Resources](../references/public-endpoints-and-resources.md#testnet-2).
