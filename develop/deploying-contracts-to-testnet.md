...
Use the generated key pair to create an account on the network. This involves sending a transaction to the nerwork's blockchain to register your account.&#x20;

#### Getting Testnet Tokens:

Many testnets have faucets that provide free test tokens. You will need to request test tokens from the faucet to fund your newly created account. You may find XION’s faucet information linked here.

## Faucet testnet Xion

Go here for instructions: [xion-testnet-1.md](../validator-nodes/obtain-funds/xion-testnet-1.md "mention")
...
[Replace `<sender_address>, <chain_id>, <gas_prices>`, and `<testnet_rpc_url>` with the appropriate values for your testnet environment.](#user-content-fn-1)[^1] These can be found in the [Network](networks.md) section.
