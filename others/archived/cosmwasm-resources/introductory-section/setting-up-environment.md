...
To set up a local testnet, see Running a Local Testnet. For details on the available XION networks, see the [Networks](../../../../developers/references/public-endpoints-and-resources.md) page.
...
{% hint style="info" %}
Get the RPC endpoint from the [public-endpoints-and-resources.md](../../../../developers/references/public-endpoints-and-resources.md "mention") section
{% endhint %}
