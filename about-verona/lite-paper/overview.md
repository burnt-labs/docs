...
{% hint style="info" %}
This document is for general information only. It is not investment advice, and it is not an offer to sell or a solicitation to buy any token or other instrument.
{% endhint %}