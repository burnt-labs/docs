---
description: Sample config.toml file
---
...
Specifically, all daemon subprocesses are disabled and serving on `localhost`
...
max_num_inbound_peers = 128

# Maximum number of outbound peers to connect to, excluding persistent peers
max_num_outbound_peers = 128
